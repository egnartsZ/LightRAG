...
def create_app(args):
    ...
    # Create routers
    document_router = create_document_routes(rag, doc_manager, api_key)
    query_router = create_query_routes(rag, api_key)
    graph_router = create_graph_routes(rag, api_key)
    prompt_router = create_prompt_routes(api_key=api_key)
